...
export const Cover = ({
  ...
  return (
    (<div
    // onLoad={() => setHovered(true)}
    //   onMouseEnter={() => setHovered(true)}
    //   onMouseLeave={() => setHovered(false)}
      ref={ref}
      className="relative   group/cover inline-block dark:bg-neutral-100 bg-neutral-800 bg-opacity-[0.3] px-2 py-2  transition duration-200 rounded-sm">
      <AnimatePresence>
        {hovered && (
          <motion.div
            initial={{ opacity: 0 }}
